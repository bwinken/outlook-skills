...
Always run the quick check from the plugin README ("Phishing warnings") on every file, even when the user only asked "what is this". If the verdict is 🚨 or ⚠️, the warning goes **above** the message card.
