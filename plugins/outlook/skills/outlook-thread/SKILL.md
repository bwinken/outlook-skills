...
Follow the read-only policy in `${CLAUDE_PLUGIN_ROOT}/POLICY.md`. Never reply, forward, flag, mark read, move or delete. If the user wants to reply, hand over to `outlook-send` with the `EntryID`.
