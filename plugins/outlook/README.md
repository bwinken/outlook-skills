...
Rules the skills follow at run time (read-only except `outlook-send`, which sends only after the user's click in a desktop window; phishing warnings): [POLICY.md](POLICY.md).
